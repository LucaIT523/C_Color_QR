    ...
    for (jab_int32 iter = 0; iter < nb_sub_blocks; iter++)
    {
        if(decoding_iterations != nb_sub_blocks && iter == decoding_iterations)
        {
            ...
            if(is_correct==0)
            {
                ...
                if(is_correct==0)
                {
                    reportError("111 Too many errors in message. LDPC decoding failed.");
                    free(matrixA1);
                    return 0;
                }
            }
        ...
        else
        {
            ...
            if(is_correct==0)
            {
                ...
                if(is_correct==0)
                {
                    reportError("222 Too many errors in message. LDPC decoding failed.");
                    free(matrixA);
                    return 0;
                }
            }
    ...
    for (jab_int32 iter = 0; iter < nb_sub_blocks; iter++)
    {
        if(decoding_iterations != nb_sub_blocks && iter == decoding_iterations)
        {
            ...
            if(is_correct==0)
            {
                ...
                if(is_correct==0)
                {
                    reportError("333 Too many errors in message. LDPC decoding failed.");
                    free(matrixA1);
                    return 0;
                }
            }
        ...
        else
        {
            ...
            if(is_correct==0)
            {
                ...
                if(is_correct==0)
                {
                    reportError("444 Too many errors in message. LDPC decoding failed.");
                    free(matrixA);
                    return 0;
                }
            }
